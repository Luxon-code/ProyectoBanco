 ...
 * @author SENA
 */
public class FrmConsignar extends javax.swing.JDialog {

    /**
     * Creates new form FrmConsignar
     */
    public FrmConsignar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        btnConsignar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/consignar.jpg"))); // NOI18N
        ...
        jPanel1.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 310, 120));
    ...
    private void btnConsignarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConsignarActionPerformed
        // TODO add your handling code here:
        if (!txtCodigo.getText().isEmpty() && !txtSaldo.getText().isEmpty()) {
            txtCodigo.setBackground(Color.white);
            txtSaldo.setBackground(Color.white);
            String codigo = txtCodigo.getText();
            int saldo = Integer.valueOf(txtSaldo.getText());
            int cuent = GestionDeCuentas.consultar(codigo);
            if (GestionDeCuentas.existeCodigo(codigo)) {
                txtCodigo.setBackground(Color.white);
                GestionDeCuentas.consignar(cuent, saldo);
                JOptionPane.showMessageDialog(null, "Consignacion exitosa");
                txtCodigo.setText(null);
                txtSaldo.setText(null);
            } else {
                JOptionPane.showMessageDialog(null, "este codigo de cuenta no existe");
                txtCodigo.setText(null);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmConsignar dialog = new FrmConsignar(new javax.swing.JFrame(), true);
